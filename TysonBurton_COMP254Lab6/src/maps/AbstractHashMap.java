...
public abstract class AbstractHashMap<K,V> extends AbstractMap<K,V> {
    ...
    private double maxLoad;              // maximum load factor
    ...
    public AbstractHashMap(double maxLoad, int cap) {
        this(maxLoad, cap, DEFAULT_PRIME);
    }

    public AbstractHashMap(double maxLoad) {
        this(maxLoad, DEFAULT_CAPACITY);
    }
